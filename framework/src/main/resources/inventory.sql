...
INSERT INTO routers(router_id, router_parent_core_id, router_type,
                    ...
                    router_ip_protocol, router_ip_address,
                    location_id)
VALUES('19a22cc8-91c9-4078-9d6f-3a5486de6ac9', null,
       'CORE', 'CISCO', 'XYZ0001', 'IPV4', '9.0.0.9', 1);

INSERT INTO routers(router_id, router_parent_core_id, router_type,
                    router_vendor, router_model,
                    router_ip_protocol, router_ip_address,
                    location_id)
VALUES('4459f845-387c-4268-9df6-6f48f5ec179c', '19a22cc8-91c9-4078-9d6f-3a5486de6ac9',
       'EDGE', 'JUNIPER', 'XYZ0001', 'IPV4', '8.0.0.8', 1);

INSERT INTO switches(switch_id, router_id, switch_type, switch_vendor, switch_model, switch_ip_protocol, switch_ip_address, location_id)
VALUES('fdd6f769-a4e4-4b5e-b59a-516543775abc', '4459f845-387c-4268-9df6-6f48f5ec179c',
       'LAYER3','CISCO','XYZ0002', 'IPV4', '40.0.0.10', 1);

INSERT INTO networks(switch_id, network_protocol, network_address, network_name, network_cidr)
VALUES('fdd6f769-a4e4-4b5e-b59a-516543775abc', 'IPV4', '40.0.0.0', 'TestNetwork', '8');

INSERT INTO routers(router_id, router_parent_core_id, router_type,
                    router_vendor, router_model,
                    router_ip_protocol, router_ip_address,
                    location_id)
VALUES('b832ef4f-f894-4194-8feb-a99c2cd4be0d', '19a22cc8-91c9-4078-9d6f-3a5486de6ac9',
